...
class CreateInteractivePlot:
    def __init__(self, data, file1_path="", file2_path=""):
        self.data = data
        ...
        self.current_file1_text = file1_path
        self.current_file2_text = file2_path
        ...
        self.current_file1_text = self.fig.text(0.13, 0.95, 'File 1 name: ' + self.current_file1_text, ha='left', va='top', fontsize=12, color='black', transform=self.fig.transFigure, bbox=dict(facecolor='white', alpha=0.5), picker=True, snap=True, zorder=100, visible=True)
        # Text showing the current file2 name
        self.current_file2_text = self.fig.text(0.13, 0.92, 'File 2 name: ' + self.current_file2_text, ha='left', va='top', fontsize=12, color='black', transform=self.fig.transFigure, bbox=dict(facecolor='white', alpha=0.5), picker=True, snap=True, zorder=100, visible=True)
...
# scatter_plot = CreateInteractivePlot(data)
